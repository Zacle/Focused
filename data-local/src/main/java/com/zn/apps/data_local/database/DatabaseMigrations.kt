...
object DatabaseMigrations {
    ...
    val MIGRATION_2_3 = object : Migration(2, 3) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL("CREATE TABLE IF NOT EXISTS `alarm` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `task_id` TEXT NOT NULL, `remind_at` TEXT NOT NULL, FOREIGN KEY (`task_id`) REFERENCES `task` (`id`) ON DELETE CASCADE)")
